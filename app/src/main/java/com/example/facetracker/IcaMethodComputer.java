...
public class IcaMethodComputer {
    ...
    public RealMatrix compute(RealMatrix data) /*throws IcaMethodException*/ {
       ...
       /* if (N == 0) {
        ...
        Log.e("TAG", "HR1 finished mean elimination");

        // computation of covariance matrix
        RealMatrix V = data.multiply(data.transpose()).scalarMultiply(1.0/N);
        Log.e("TAG", "HR1 finished computation of covariance");
        ...
        Log.e("TAG", "HR1 finished computation of whitening matrix");
        ...
        for (int iteration=0; iteration<C; ++iteration) {
            ...
            normalize(w0);
            Log.e("TAG", "HR1 iteration: "+iteration+" / "+C);

            int counter = 0;
            while (true) {
                Log.e("TAG", "HR1 Keep looping ..");
                ...
                w0 = w1;
                counter++;
                if ((Math.abs(w0w1 - 1.0) < 1.0e-6) || counter>=10) {
                    counter =0;
                    break;
                }
            }
        ...
        Log.e("TAG", "HR1 finished ICA Iterations??");
    ...
    public static RealMatrix power(final RealMatrix matrix, final double p) {
        final EigenDecomposition eigen = new EigenDecomposition(matrix, 0.0);
